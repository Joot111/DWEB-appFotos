...
namespace AppFotos.Data.Seed
{
    internal class DbInitializer
    {
        ...
        internal static async void Initialize(ApplicationDbContext dbContext)
        {
            ...
            if (dbContext.Categorias.Count() == 5)
            {
                categorias = [
                   new Categorias { Nome = "Paisagens" },
                   new Categorias { Nome = "Faróis" },
                   new Categorias { Nome = "Castelos" },
                   new Categorias { Nome = "Pontes" }
